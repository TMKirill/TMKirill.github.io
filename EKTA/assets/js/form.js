...
more_people_wrapper[0].querySelector('.second-form__more-people').addEventListener('click', more_people);

function more_people(){
    console.log(this.closest('.second-form__more-people-wrapper'));
    const new_person_element = this.closest('.second-form__more-people-wrapper');
...
//    const more_people_wrapper = document.querySelectorAll('.second-form__more-people-wrapper');
    ...
    if(new_person_element.querySelector('.second-form__more-people-img').classList.contains('second-form__more-people-img-visible') == false){ 
        new_person_element.querySelector('.second-form__more-people-img').classList.add('second-form__more-people-img-visible');
        new_person_element.querySelector('.second-form__more-people span').style.margin = '0';
        new_person_element.insertAdjacentHTML('beforeend', new_person)
        new_person_element.insertAdjacentHTML('afterend', new_person_wrapper);
        more_people_wrapper = document.querySelectorAll('.second-form__more-people-wrapper');
        more_people_wrapper[more_people_wrapper.length-1].querySelector('.second-form__more-people').addEventListener('click', more_people);
        new_person_element.querySelector('.second-form__more-people span').innerHTML = 'Турист №' + String(more_people_wrapper.length - 1); console.log(more_people_wrapper[more_people_wrapper.length-1]);
        console.log(more_people_wrapper.length);
    }
    else{ 
        new_person_element.classList.remove('second-form__more-people-img-visible')
        new_person_element.querySelector('.second-form__more-people span').style.margin = '0 auto';
        new_person_element.querySelector('.second-form__more-people span').innerHTML = '+Додати учасника';
        new_person_element.innerHTML = new_person_element.innerHTML.replace(new_person, '');
        more_people_outer.removeChild(new_person_element)
        more_people_wrapper = document.querySelectorAll('.second-form__more-people-wrapper');
        for(let i = 0; i<more_people_wrapper.length-1; i++){
            more_people_wrapper[i].querySelector('.second-form__more-people span').innerHTML = 'Турист №' + (i + 1);
        }
    }
}
